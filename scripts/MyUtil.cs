...
public static class MyUtil
{
    ...
    public static int GetXPForLevel(int level)
    {
        ...
        {
            total += (int) MathF.Floor(i + 300 * MathF.Pow(2, i / 7.0f));
        }
    ...
    public static int GetLevelForXP(int xp)
    {
        ...
        for (level = 0; level < 120; level++) if (GetXPForLevel(level + 1) > xp)
        {
            break;
        }
    ...
    public static bool TryParseSkillType(string text, out SkillType type)
    {
        type = SkillType.Null;
        return Enum.TryParse(text, true, out type);
    }
    
    public static Vector4 GetColorForRarity(MyItemRarity rarity) => rarity switch
    {
        MyItemRarity.Uncommon =>  new(0.425f, 1, 0.107f, 1f),
        MyItemRarity.Rare =>      new(0, 0.978f, 1, 1f),
        MyItemRarity.Epic =>      new(0.867f, 0, 1f, 1f),
        MyItemRarity.Legendary => new(1f, 0.75f, 0f, 1f),
        MyItemRarity.Mythic =>    new(0.8f, 0.044f, 0.05f, 1f),
        MyItemRarity.MegaRare =>    new(0.227f, 0.106f, 0.624f, 1f),
        _ =>                    new(1f, 1f, 1f, 1f),
    };
    ...
    public static int GetGlobalHealthForLevel(int level)
    {
        return level * 10;
    }
...
{
    public static void Start(Entity entity, float time)
    {
        var component = entity.AddComponent<DestroyAfter>();
